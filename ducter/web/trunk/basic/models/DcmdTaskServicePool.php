...
class DcmdTaskServicePool extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['task_id', 'task_cmd', 'svr_pool', 'svr_pool_id', 'state','env_ver', 'repo', 'run_user', 'undo_node', 'doing_node', 'finish_node', 'fail_node', 'ignored_fail_node', 'ignored_doing_node', 'utime', 'ctime', 'opr_uid'], 'required'],
